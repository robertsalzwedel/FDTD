...
if FLAG.MATERIAL != 0 and FLAG.MICRO != 0:
    ...
    exit()
if FLAG.MICRO == 1 or FLAG.MATERIAL == 1:
    eps_in = 1.0
# Drude model
if FLAG.MATERIAL == 1 and FLAG.MICRO == 0:  # Steve data atm, Vial data provided
...
if FLAG.MATERIAL == 2 and FLAG.MICRO == 0:
    eps_in = 5.9673
    wp = 1.328e16
    gamma = 1e14
    wl = 4.08e15
...
if FLAG.MATERIAL == 3 and FLAG.MICRO == 0:
    eps_in = 1.53
    wp = 1.299e16
    gamma = 1.108e14
    w1 = 4.02489654142e15
