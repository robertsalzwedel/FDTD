...
def store_point(FLAG,sphere,ddx,dt,tsteps,dims,pulse,dft,npml,eps_in,eps_out,source,pulsemon_t,ez_source_t,start,stop):

    filename = 'point_object{}_r{}_dx{}_T{}_X{}_lam{}_wdt{}_nfreq{}_xs{}_ys{}_zs{}_npml{}_eps{}_final_new'\
        .format(FLAG.OBJECT,int(sphere.R/nm),int(ddx/nm),tsteps,dims.x,int(pulse.lam_0/nm),int(pulse.width),dft.iwdim,source.x,source.y,source.z,npml,eps_in)
...
def store_cross(FLAG,sphere,ddx,dt,tsteps,dims,pulse,dft,npml,eps_in,eps_out,start,stop,
    ...
    filename = 'TFSF_object{}_r{}_dx{}_T{}_X{}_lam{}_wdt{}_nfreq{}_npml{}_eps{}_tfsf{}'\
        .format(FLAG.OBJECT,int(sphere.R/nm),int(ddx/nm),tsteps,dims.x,int(pulse.lam_0/nm),int(pulse.width),dft.iwdim,npml,eps_in,tfsf_dist)
...
def store_periodic(FLAG,sphere,ddx,dt,tsteps,dims,pulse,dft,npml,eps_in,eps_out,start,stop,
    ...
    filename = 'periodic_object{}_material{}_r{}_dx{}_T{}_X{}_lam{}_wdt{}_nfreq{}_npml{}_tfsf{}'\
        .format(FLAG.OBJECT,FLAG.MATERIAL,int(sphere.R/nm),int(ddx/nm),tsteps,dims.x,int(pulse.lam_0/nm),int(pulse.width),dft.iwdim,npml,tfsf_dist)
...
def store_periodic_micro(FLAG,sphere,ddx,dt,tsteps,dims,pulse,dft,npml,eps_in,eps_out,start,stop,
